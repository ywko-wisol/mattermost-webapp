...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .input-group-addon, .app__body .post-create__container .post-body__actions > div + div', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.1));
